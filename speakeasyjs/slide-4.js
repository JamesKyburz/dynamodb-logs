...
It did this using {cyanBright https://github.com/JamesKyburz/aws-lambda-http-server}

I have since worked on many projects using serverless on AWS.

To name a few things, serverless to me means

{green ●} less time in devops and terraform land and nore more patching
{strikethrough ● cheaper (ok everything is relative)}
...
I built {cyanBright https://github.com/JamesKyburz/sandbox-debugger} to make interactively debug.
`
